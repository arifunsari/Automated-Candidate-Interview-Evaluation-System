...
print("Starting the interview simulation...")
...
async def my_agents(job_position = "AI Engineer"):
    ...
    candidate = UserProxyAgent(  # give the Input
        name= "Candidate",
    ...
    evaluation = AssistantAgent(  # agent 3
        name = "Evaluator",
        model_client= model_client,
    ...
    terninate_condition = TextMentionTermination(text="TERMINATE") # termination condition for the interview process
...
## Test the entire workflow of the interview process
